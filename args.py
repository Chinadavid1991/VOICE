...
parser.add_argument('--mode', default='prediction', type=str, choices=['training', 'training', 'prediction'])
...
parser.add_argument('--voice_dir', default='./Train/loushui', type=str)
...
parser.add_argument('--nb_samples', default=2000, type=int)
...
parser.add_argument('--name_model', default='model_save', type=str)
# directory where read noisy sound to denoise (prediction mode)
parser.add_argument('--audio_dir_prediction', default='./demo_data/valid', type=str)
...
parser.add_argument('--audio_input_prediction', default=['bk_01.wav'], type=list)
# File name of sound output of denoise prediction
parser.add_argument('--audio_output_prediction', default='noisy_voice_gen.wav', type=str)
# Sample rate chosen to read audio
parser.add_argument('--sample_rate', default=12000, type=int)
